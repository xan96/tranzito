      ...
      <div class="max-w-6xl mx-auto px-4">
        <div class="grid md:grid-cols-2 gap-8">
          ...
          <div class="bg-white rounded-3xl p-6 md:p-10">
            <div class="w-12 h-12 bg-[#ffdd2d] rounded-xl flex items-center justify-center mb-6">
            ...
            <ul class="space-y-4">
              <li class="flex items-start gap-3">
                ...
                <span class="text-gray-600">Быстрое оформление заявок через удобные формы</span>
              </li>
              <li class="flex items-start gap-3">
                <svg class="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                <span class="text-gray-600">Отслеживание статуса заявок в реальном времени</span>
              </li>
              <li class="flex items-start gap-3">
                <svg class="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                <span class="text-gray-600">Доступ к широкому пулу инвесторов</span>
              </li>
              <li class="flex items-start gap-3">
                <svg class="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                <span class="text-gray-600">Уведомления о всех изменениях по заявкам</span>
              </li>
            </ul>
            <TButton to="/login" class="mt-8" size="lg">
              Подать заявку
            </TButton>
          </div>

          <!-- For investors -->
          <div id="for-investors" class="bg-white rounded-3xl p-6 md:p-10">
            <div class="w-12 h-12 bg-[#ffdd2d] rounded-xl flex items-center justify-center mb-6">
              <svg class="w-6 h-6 text-gray-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <ul class="space-y-4">
              <li class="flex items-start gap-3">
                ...
                <span class="text-gray-600">Прозрачные условия и полная документация</span>
              </li>
              <li class="flex items-start gap-3">
                <svg class="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                <span class="text-gray-600">Короткий срок инвестирования от {{ LOAN_TERM_MIN_DAYS }} до {{ LOAN_TERM_MAX_DAYS }} дней</span>
              </li>
              <li class="flex items-start gap-3">
                <svg class="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                <span class="text-gray-600">Обеспечение недвижимостью с низким LTV</span>
              </li>
              <li class="flex items-start gap-3">
                <svg class="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                <span class="text-gray-600">Доходность до 36% годовых</span>
              </li>
            </ul>
            <TButton to="/login" class="mt-8" size="lg">
              Смотреть заявки
    ...
    <section class="py-20 bg-white">
      <div class="max-w-4xl mx-auto px-4 text-center">
        ...
        <p class="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
          Присоединяйтесь к платформе Транзито и получите доступ к быстрому транзитному финансированию
        </p>
        <TButton to="/login" size="xl">
          Начать работу
        </TButton>
      ...
      <div class="max-w-6xl mx-auto px-4">
        <div class="flex flex-col md:flex-row items-center justify-between gap-6">
          <div class="flex items-center gap-2.5">
            <TLogo :size="32" />
            <div class="text-2xl font-bold">Транзито</div>
          </div>
          <div class="text-gray-400 text-sm">
            &copy; 2024 Транзито. Все права защищены.
          </div>
        </div>
      </div>
    </footer>
